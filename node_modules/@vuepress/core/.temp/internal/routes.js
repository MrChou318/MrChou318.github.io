...
import GlobalLayout from "D:\\work\\project\\vue-press\\node_modules\\@vuepress\\core\\lib\\client\\components\\GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-3356468a").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  },
  {
    ...
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-1555a35a").then(next)
    },
  },
  {
    name: "v-b1564aac",
